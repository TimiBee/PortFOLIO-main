        ...
        <section className='text-secondary md:py-0 px-8'>
           <div className="flex justify-center">
            ...
            hover:text-black text-center uppercase">
                <a 
                href="mailto:atimilewis55@gmail.com?subject=Hello Timi B,...">       
                   Get in Touch  
                </a> 
            </p>
        <motion.footer 
            ...
            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
                <a href='https://www.linkedin.com/in/busayo-timi-b-a467a420a/' 
            ...
            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
            <a href='https://github.com/TimiBee' 
            target='_blank' rel='noopener noreferrer'>
                <AiFillGithub/>
            </a>
            </li>
            ...
            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
            <a href='https://twitter.com/Timi_Bee' 
            target='_blank' rel='noopener noreferrer'>
                <AiOutlineTwitter/>
            </a>
            </li> 
